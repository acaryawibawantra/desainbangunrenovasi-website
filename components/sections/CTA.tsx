            ...
            <div className="relative mx-auto max-w-7xl px-6 md:px-12 py-16 md:py-24">
                <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-12">
                    ...
                    >
                        ...
                        <Link
                            href="/contact"
                            className="group inline-flex items-center gap-3 border border-white/25 text-white/80 hover:text-white hover:border-white/50 transition-all duration-300 px-8 py-4 text-sm tracking-wide"
                        >
                        ...
                        <p className="text-white/30 text-xs lg:text-right">Respons dalam 1×24 jam</p>
                    </motion.div>
                </div>
            </div>
        </section>
